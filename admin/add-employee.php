                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="department" autocomplete="off">
                                                ...
                                                {   ?> 
                                                <option value="<?php echo htmlentities($result->deptCode);?>"><?php echo htmlentities($result->deptCode);?></option>
                                                <?php }} ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="position" autocomplete="off">
                                                ...
                                                foreach($results as $result)
                                                {   ?> 
                                                <option value="<?php echo htmlentities($result->posCode);?>"><?php echo htmlentities($result->posCode);?></option>
                                                <?php }} ?>
                                            </select>
                                        </div>
