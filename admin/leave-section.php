<?php
    ...
    include('../includes/dbconn.php');
        ...
        if(strlen($_SESSION['alogin'])==0){   
            ...
            if(isset($_GET['del'])){
                $id = $_GET['del'];
                $sql = "DELETE from  leave_types  WHERE SN=:id";
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Manage Leave Types</span></li>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-leavetype.php" class="btn btn-sm btn-info">Add New Leave Type</a></center>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tbody>
                                            <?php $sql = "SELECT * from leave_types";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                            ...
                                            {               ?>   
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-leaveType.php?lid=<?php echo htmlentities($result->SN);?>">
                                                        <i class="fa fa-edit" style="color:green"></i></a>
                                                        <a href="leave-section.php?del=<?php echo htmlentities($result->SN);?>" onclick="return confirm('Do you want to delete?');">
